...
async function fetchQuranData(surah, ayah = null) {
    try {
        ...
        if (response.data.status === 'OK') {
            ...
            return null;  // If the response status is not OK, treat it as a not found case
        }
    } catch (error) {
        console.error("Quran ma'lumotlarini olishda xatolik:", error);
...
// Modify this part where you send the full surah
if (ayahNumber) {
